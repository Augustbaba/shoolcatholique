...
<div class="dashboard-main-body">
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
            <h1 class="fw-semibold mb-4 h6 text-primary-light">Nouvelle période</h1>
            <div>
                ...
                <div class="mb-3">
                    ...
                    <select name="annee_scolaire_id" id="annee_scolaire_id" class="form-select @error('annee_scolaire_id') is-invalid @enderror" required>
                        ...
                        @foreach($annees as $annee)
                            <option value="{{ $annee->id }}" {{ old('annee_scolaire_id', $annee->est_active ? $annee->id : '') == $annee->id ? 'selected' : '' }}>
                                {{ $annee->libelle }}
                            </option>
                        @endforeach
                    </select>
